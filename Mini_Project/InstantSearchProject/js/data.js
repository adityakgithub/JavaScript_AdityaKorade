...
//     //console.log("DataAtFirst"+data);
//     return data.forEach(a=>console.log(a.Title));
// }
...
// // .then(result=>{return result.forEach(a=>console.log(a.Title))})
// // .catch(error=>console.error(error));
// //data().then(result=>{return result.forEach(a=>console.log(a.Title))});
